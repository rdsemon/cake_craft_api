...
export const getAllCakes = asyncHandler(async (req: Request, res: Response) => {
  ...
  const result = await getAllCakesService(options as GetCakesOptions);
  res.status(200).json({
    status: "successful",
...
export const getOneCakeById = asyncHandler(
...
export const updateCakeInfo = asyncHandler(
  async (req: Request, res: Response) => {
    const id = String(req.params.id);
...
export const deleteCakeById = asyncHandler(
  async (req: Request, res: Response) => {
...
export const deleteAllCakes = asyncHandler(
  async (req: Request, res: Response) => {
